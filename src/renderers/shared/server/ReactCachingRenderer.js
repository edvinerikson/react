 ...
 *
 * @providesModule ReactCachingRenderer
 */
  ...
  read(bytes) {
    ...
    while (out.length < bytes) {
      ...
      if (frame.isCacheFrame) {
        ...
        if (this.isCaching) {
          cacheOut += this.render(child, frame.context, frame.domNamespace);
        } else {
...
module.exports = ReactDOMCachingServerRenderer;
